...
// Add the inputPanelContainer to the main panel (bottom section)
    ...
    public void setSelectedCode(String code) {
        ...
        if (code != null && !code.trim().isEmpty()) {
            ...
            // No code selected: do not append the “Generate Documentation” label, allow input
            enableInput();
        }
    ...
    private void appendUserMessage(String text, boolean isNewChat) {
        SwingUtilities.invokeLater(() -> {
            ...
            if (isNewChat && !lastSelectedCode.isEmpty()) {
                message.append("<pre style='color:gray; background:#282828; padding:5px; white-space:pre-wrap; word-wrap:break-word;'>")
